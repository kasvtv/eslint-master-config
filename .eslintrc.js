...
module.exports = {
  ...
  parser: babel ? 'babel-eslint' : typescript ? '@typescript-eslint/parser' : null,
  parserOptions: {
    sourceType: 'module',
    ecmaVersion,
  ...
  rules: Object.assign(
    {
      ...
      'comma-dangle': [
        style,
        {
          ...
          functions:
            babel || typescript || minSupportedEcmaVersion >= 6 ? 'always-multiline' : 'ignore',
        },
      ],
      ...
      [`${tsPrefix}no-unused-expressions`]: 'off',
      ...
      'object-shorthand': babel || typescript || minSupportedEcmaVersion >= 6 ? 'warn' : 'off',
      'one-var': ['error', 'never'],
    ...
    typescript && {
      ...
      '@typescript-eslint/member-delimiter-style': [
        style,
        {
          multiline: { delimiter: semiSetting ? 'semi' : 'none', requireLast: true },
      ...
      '@typescript-eslint/no-explicit-any': strict ? 'error' : 'off',
